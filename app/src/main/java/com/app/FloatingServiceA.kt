...
class FloatingServiceA : Service(), View.OnClickListener {
    ...
    override fun onCreate() {
        ...
        if (!NotificationManagerCompat.from(this@FloatingServiceA).areNotificationsEnabled()) {
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.open_activity_button -> {
                ...
                val intent = Intent(this@FloatingServiceA, MainActivity::class.java)
