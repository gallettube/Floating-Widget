...
public class FloatingService extends Service implements View.OnClickListener {
    ...
    public void onCreate() {
        ...
        if(!NotificationManagerCompat.from(FloatingService.this).areNotificationsEnabled()){
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.open_activity_button:
                Toast.makeText(FloatingService.this, "Boton pulsado", Toast.LENGTH_SHORT).show();
